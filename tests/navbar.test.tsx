...
describe("Navbar", () => {
  ...
  it("should display logout button when authenticated", () => {
    ...
    renderWithProviders(<Navbar />, { preloadedState: { auth: { loggedIn: true }, ui: { loading: false } } });
  ...
  it("should display loading bar when loading", () => {
    renderWithProviders(<Navbar />, { preloadedState: { auth: { loggedIn: true }, ui: { loading: true } } });
